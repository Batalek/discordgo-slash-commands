...
var (
	...
	EndpointApplicationGuildCommands = func(aID string, gID string) string { return EndpointApplicationNoOauth(aID) + "/guilds/" + gID + "/commands"}
	EndpointInteractionResponse = func(iID string, iToken string) string {return discordgo.EndpointAPI + "/interactions/" + iID + "/" + iToken + "/callback"}
)
